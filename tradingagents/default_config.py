...
DEFAULT_CONFIG = _apply_env_overrides({
    ...
    "benchmark_map": {
        ...
        ".PA":  "^FCHI",       # Euronext Paris (CAC 40)
        ".AS":  "^AEX",        # Euronext Amsterdam (AEX)
        ".BR":  "^BFX",        # Euronext Brussels (BEL 20)
        ".MI":  "FTSEMIB.MI",  # Milan (FTSE MIB; Yahoo has no caret symbol)
        ".MC":  "^IBEX",       # Madrid (IBEX 35)
        ".SW":  "^SSMI",       # SIX Swiss (SMI)
        ".ST":  "^OMX",        # Stockholm (OMXS30)
        ".VI":  "^ATX",        # Vienna (ATX)
